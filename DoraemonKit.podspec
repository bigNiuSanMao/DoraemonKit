...
Pod::Spec.new do |s|
  s.name             = 'DoraemonKit'
  s.version          = '3.0.4-custom'
  s.summary          = 'iOS各式各样的工具集合'
  s.description      = <<-DESC
                          iOS各式各样的工具集合 Desc
                       DESC

  s.homepage         = 'https://github.com/bigNiuSanMao/DoraemonKit'
  s.license          = { :type => 'Apache-2.0', :file => 'LICENSE' }
  s.author           = { 'yixiang' => 'javer_yi@163.com' }
  s.source           = { :git => 'https://github.com/bigNiuSanMao/DoraemonKit.git', :tag => s.version.to_s }
